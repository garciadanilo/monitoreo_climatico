...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { deleted: @sensor.deleted, descripcion: @sensor.descripcion, nombre: @sensor.nombre }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { deleted: @sensor.deleted, descripcion: @sensor.descripcion, nombre: @sensor.nombre }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
