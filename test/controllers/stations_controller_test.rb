...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { deleted: @station.deleted, descripcion: @station.descripcion, enabled: @station.enabled, nombre: @station.nombre }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { deleted: @station.deleted, descripcion: @station.descripcion, enabled: @station.enabled, nombre: @station.nombre }
    assert_redirected_to station_path(assigns(:station))
  end
